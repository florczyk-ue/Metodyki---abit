...
label_bdate.grid(row=7, column=0, padx=10, pady=5, sticky="w")
entry_bdate = tk.Entry(root, width=40)
entry_bdate.grid(row=7, column=1, padx=10, pady=5)
label_ID = tk.Label(root, text="Preferencje wolontariackie")
label_ID.grid(row=8, column=0, padx=10, pady=5, sticky="w")
label_ID = tk.Entry(root, width=40)
label_ID.grid(row=8, column=1, padx=10, pady=5)
label_DG = tk.Label(root, text="Rozmiar koszulki")
label_DG.grid(row=9, column=0, padx=10, pady=5, sticky="w")
label_DG = tk.Entry(root, width=40)
label_DG.grid(row=9, column=1, padx=10, pady=5)
label_EX = tk.Label(root, text="Dlaczego chcesz być wolontariuszem?")
label_EX.grid(row=10, column=0, padx=10, pady=5, sticky="w")
label_EX = tk.Entry(root, width=40)
label_EX.grid(row=10, column=1, padx=10, pady=5)
